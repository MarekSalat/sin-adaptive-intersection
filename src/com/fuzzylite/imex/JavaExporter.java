...
public class JavaExporter extends Exporter {
    ...
    public String toString(Term term) {
        ...
        if (term instanceof Discrete) {
            ...
            String result = String.format("%s.createSimpleWorld(\"%s\", %s)",
        ...
        if (term instanceof Function) {
            ...
            String result = String.format("%s.createSimpleWorld(\"%s\", \"%s\", engine, true)",
        ...
        if (term instanceof Linear) {
            ...
            String result = String.format("%s.createSimpleWorld(\"%s\", engine.getInputVariables(), %s)",
