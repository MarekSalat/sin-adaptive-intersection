...
public class CppExporter extends Exporter {
    ...
    public String toString(Term term) {
        ...
        if (term instanceof Discrete) {
            ...
            String result = String.format("fl::%s::createSimpleWorld(\"%s\", %d, %s)",
        ...
        if (term instanceof Function) {
            ...
            String result = String.format("fl::%s::createSimpleWorld(\"%s\", \"%s\", engine)",
        ...
        if (term instanceof Linear) {
            ...
            String result = String.format("fl::%s::createSimpleWorld(\"%s\", engine->inputVariables(), %s)",
